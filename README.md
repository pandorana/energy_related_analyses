...
# Run the project
To run the project you just type `source("setup.R")` into the console, the environment should set up automatically in few minutes for the first time, and gets faster for later loading. Warning messages of 'Unknown levels' are normal and do not needs handling.
